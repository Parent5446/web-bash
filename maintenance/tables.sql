...
INSERT INTO `webbash`.`file` (`parent`, `id`, `name`, `size`, `filetype`, `owner`, `grp`, `perms`, `atime`, `ctime`, `mtime`) VALUES (2, 4, 'hostname', 9, 'f', NULL, NULL, 420, NOW(), NOW(), NOW());
INSERT INTO `webbash`.`file` (`parent`, `id`, `name`, `size`, `filetype`, `owner`, `grp`, `perms`, `atime`, `ctime`, `mtime`) VALUES (1, 5, 'welcome', 53, 'f', NULL, NULL, 420, NOW(), NOW(), NOW());
