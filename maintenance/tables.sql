...
INSERT INTO `webbash`.`file` (`parent`, `id`, `name`, `filetype`, `owner`, `grp`, `perms`) VALUES (NULL, 3, 'home', 'd', NULL, NULL, 493);
INSERT INTO `webbash`.`file` (`parent`, `id`, `name`, `filetype`, `owner`, `grp`, `perms`) VALUES (2, 4, 'hostname', 'f', NULL, NULL, 420);
